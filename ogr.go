...
func CreateFromWKB(wkb []uint8, srs SpatialReference, bytes int) (Geometry, error) {
	...
	return newGeom, OGRErrContainer{C.go_CreateFromWkb(
...
func CreateFromWKT(wkt string, srs SpatialReference) (Geometry, error) {
	...
	var newGeom Geometry
	return newGeom, OGRErrContainer{C.OGR_G_CreateFromWkt(
...
func (geom Geometry) FromWKB(wkb []uint8, bytes int) error {
	cString := unsafe.Pointer(&wkb[0])
	return OGRErrContainer{C.go_ImportFromWkb(geom.cval, cString, C.int(bytes))}.Err()
}
...
func (geom Geometry) ToWKB() ([]uint8, error) {
	...
	err := OGRErrContainer{C.go_ExportToWkb(geom.cval, C.OGRwkbByteOrder(C.wkbNDR), cString)}.Err()
	return b, err
}
...
func (geom Geometry) FromWKT(wkt string) error {
	cString := C.CString(wkt)
	defer C.free(unsafe.Pointer(cString))
	return OGRErrContainer{C.OGR_G_ImportFromWkt(geom.cval, &cString)}.Err()
}

// Fetch geometry as WKT
func (geom Geometry) ToWKT() (string, error) {
	var p *C.char
	err := OGRErrContainer{C.OGR_G_ExportToWkt(geom.cval, &p)}.Err()
	wkt := C.GoString(p)
...
func (geom Geometry) Transform(ct CoordinateTransform) error {
	return OGRErrContainer{C.OGR_G_Transform(geom.cval, ct.cval)}.Err()
}

// Transform geometry to new spatial reference system
func (geom Geometry) TransformTo(sr SpatialReference) error {
	return OGRErrContainer{C.OGR_G_TransformTo(geom.cval, sr.cval)}.Err()
}
...
func (geom Geometry) AddGeometry(other Geometry) error {
	return OGRErrContainer{C.OGR_G_AddGeometry(geom.cval, other.cval)}.Err()
}
...
func (geom Geometry) AddGeometryDirectly(other Geometry) error {
	return OGRErrContainer{C.OGR_G_AddGeometryDirectly(geom.cval, other.cval)}.Err()
}

// Remove a geometry from the geometry container
func (geom Geometry) RemoveGeometry(index int, delete bool) error {
	return OGRErrContainer{C.OGR_G_RemoveGeometry(geom.cval, C.int(index), BoolToCInt(delete))}.Err()
}
...
func (geom Geometry) BuildPolygonFromEdges(autoClose bool, tolerance float64) (Geometry, error) {
	...
	return Geometry{newGeom}, OGRErrContainer{cErr}.Err()
}
...
func (fd FeatureDefinition) DeleteFieldDefinition(index int) error {
	return OGRErrContainer{C.OGR_FD_DeleteFieldDefn(fd.cval, C.int(index))}.Err()
}
...
func (fd FeatureDefinition) ReorderFieldDefinitions(panmap []int) error {
	...
	return OGRErrContainer{C.OGR_FD_ReorderFieldDefns(fd.cval, &cmap[0])}.Err()
}
...
func (fd FeatureDefinition) DeleteGeomFieldDefinition(index int) error {
	return OGRErrContainer{C.OGR_FD_DeleteGeomFieldDefn(fd.cval, C.int(index))}.Err()
}
...
func (feature Feature) SetGeometry(geom Geometry) error {
	return OGRErrContainer{C.OGR_F_SetGeometry(feature.cval, geom.cval)}.Err()
}

// Set feature geometry, passing ownership to the feature
func (feature Feature) SetGeometryDirectly(geom Geometry) error {
	return OGRErrContainer{C.OGR_F_SetGeometryDirectly(feature.cval, geom.cval)}.Err()
}
...
func (feature Feature) SetGeometryFieldDirectly(index int, geom Geometry) error {
	return OGRErrContainer{C.OGR_F_SetGeomFieldDirectly(feature.cval, C.int(index), geom.cval)}.Err()
}
...
func (feature Feature) SetGeometryField(index int, geom Geometry) error {
	return OGRErrContainer{C.OGR_F_SetGeomField(feature.cval, C.int(index), geom.cval)}.Err()
}
...
func (feature Feature) SetFID(fid int64) error {
	return OGRErrContainer{C.OGR_F_SetFID(feature.cval, C.GIntBig(fid))}.Err()
}
...
func (this Feature) SetFrom(other Feature, forgiving int) error {
	return OGRErrContainer{C.OGR_F_SetFrom(this.cval, other.cval, C.int(forgiving))}.Err()
}
...
func (this Feature) SetFromWithMap(other Feature, forgiving int, fieldMap []int) error {
	return OGRErrContainer{C.OGR_F_SetFromWithMap(
		this.cval,
		other.cval,
		C.int(forgiving),
...
func (layer Layer) SetAttributeFilter(filter string) error {
	...
	return OGRErrContainer{C.OGR_L_SetAttributeFilter(layer.cval, cFilter)}.Err()
}
...
func (layer Layer) SetNextByIndex(index int64) error {
	return OGRErrContainer{C.OGR_L_SetNextByIndex(layer.cval, C.GIntBig(index))}.Err()
}
...
func (layer Layer) SetFeature(feature Feature) error {
	return OGRErrContainer{C.OGR_L_SetFeature(layer.cval, feature.cval)}.Err()
}

// Create and write a new feature within a layer
func (layer Layer) Create(feature Feature) error {
	return OGRErrContainer{C.OGR_L_CreateFeature(layer.cval, feature.cval)}.Err()
}

// Delete indicated feature from layer
func (layer Layer) Delete(index int64) error {
	return OGRErrContainer{C.OGR_L_DeleteFeature(layer.cval, C.GIntBig(index))}.Err()
}
...
func (layer Layer) Extent(force bool) (env Envelope, err error) {
	err = OGRErrContainer{C.OGR_L_GetExtent(layer.cval, &env.cval, BoolToCInt(force))}.Err()
	return
}
...
func (layer Layer) ExtentEx(index int, force bool) (env Envelope, err error) {
	err = OGRErrContainer{C.OGR_L_GetExtentEx(layer.cval, C.int(index), &env.cval, BoolToCInt(force))}.Err()
	return
}
...
func (layer Layer) CreateField(fd FieldDefinition, approxOK bool) error {
	return OGRErrContainer{C.OGR_L_CreateField(layer.cval, fd.cval, BoolToCInt(approxOK))}.Err()
}
...
func (layer Layer) DeleteField(index int) error {
	return OGRErrContainer{C.OGR_L_DeleteField(layer.cval, C.int(index))}.Err()
}

// Reorder all the fields of a layer
func (layer Layer) ReorderFields(layerMap []int) error {
	return OGRErrContainer{C.OGR_L_ReorderFields(layer.cval, (*C.int)(unsafe.Pointer(&layerMap[0])))}.Err()
}

// Reorder an existing field of a layer
func (layer Layer) ReorderField(oldIndex, newIndex int) error {
	return OGRErrContainer{C.OGR_L_ReorderField(layer.cval, C.int(oldIndex), C.int(newIndex))}.Err()
}
...
func (layer Layer) SetIgnoredFields(names []string) error {
	...
	return OGRErrContainer{C.OGR_L_SetIgnoredFields(layer.cval, (**C.char)(unsafe.Pointer(&cNames[0])))}.Err()
}
...
func (ds DataSource) Release() error {
	return OGRErrContainer{C.OGRReleaseDataSource(ds.cval)}.Err()
}
...
func (ds DataSource) Delete(index int) error {
	return OGRErrContainer{C.OGR_DS_DeleteLayer(ds.cval, C.int(index))}.Err()
}
...
func (ds DataSource) Sync() error {
	return OGRErrContainer{C.OGR_DS_SyncToDisk(ds.cval)}.Err()
}
...
func (driver OGRDriver) Delete(filename string) error {
	cFilename := C.CString(filename)
	defer C.free(unsafe.Pointer(cFilename))
	return OGRErrContainer{C.OGR_Dr_DeleteDataSource(driver.cval, cFilename)}.Err()
}
