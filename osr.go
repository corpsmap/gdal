...
func (sr SpatialReference) FromWKT(wkt string) error {
	cString := C.CString(wkt)
	defer C.free(unsafe.Pointer(cString))
	return OGRErrContainer{C.OSRImportFromWkt(sr.cval, &cString)}.Err()
}

// Export coordinate system to WKT
func (sr SpatialReference) ToWKT() (string, error) {
	var p *C.char
	err := OGRErrContainer{C.OSRExportToWkt(sr.cval, &p)}.Err()
	wkt := C.GoString(p)
	return wkt, err
}
...
func (sr SpatialReference) ToPrettyWKT(simplify bool) (string, error) {
	var p *C.char
	err := OGRErrContainer{C.OSRExportToPrettyWkt(
...
func (sr SpatialReference) FromEPSG(code int) error {
	return OGRErrContainer{C.OSRImportFromEPSG(sr.cval, C.int(code))}.Err()
}

// Initialize SRS based on EPSG code, using EPSG lat/long ordering
func (sr SpatialReference) FromEPSGA(code int) error {
	return OGRErrContainer{C.OSRImportFromEPSGA(sr.cval, C.int(code))}.Err()
}
...
func (sr SpatialReference) Validate() error {
	return OGRErrContainer{C.OSRValidate(sr.cval)}.Err()
}
...
func (sr SpatialReference) FromProj4(input string) error {
	...
	defer C.free(unsafe.Pointer(cString))
	return OGRErrContainer{C.OSRImportFromProj4(sr.cval, cString)}.Err()
}

// Export coordinate system in PROJ.4 format
func (sr SpatialReference) ToProj4() (string, error) {
	var p *C.char
	err := OGRErrContainer{C.OSRExportToProj4(sr.cval, &p)}.Err()
	proj4 := C.GoString(p)
	return proj4, err
}
...
func (sr SpatialReference) FromPCI(proj, units string, params []float64) error {
	...
	return OGRErrContainer{C.OSRImportFromPCI(
		sr.cval,
		cProj,
		cUnits,
...
func (sr SpatialReference) FromUSGS(projsys, zone int, params []float64, datum int) error {
	return OGRErrContainer{C.OSRImportFromUSGS(
		sr.cval,
		C.long(projsys),
		C.long(zone),
		(*C.double)(unsafe.Pointer(&params[0])),
...
func (sr SpatialReference) FromXML(xml string) error {
	...
	return OGRErrContainer{C.OSRImportFromXML(sr.cval, cXml)}.Err()
}
...
func (sr SpatialReference) FromERM(proj, datum, units string) error {
	...
	return OGRErrContainer{C.OSRImportFromERM(sr.cval, cProj, cDatum, cUnits)}.Err()
}
...
func (sr SpatialReference) ToUSGS() (proj, zone int, params []float64, datum int, errVal error) {
	err := OGRErrContainer{C.OSRExportToUSGS(
		sr.cval,
...
func (sr SpatialReference) ToXML() (xml string, errVal error) {
	var x *C.char
	err := OGRErrContainer{C.OSRExportToXML(sr.cval, &x, nil)}.Err()
...
func (sr SpatialReference) ToMICoordSys() (output string, errVal error) {
	var x *C.char
	err := OGRErrContainer{C.OSRExportToMICoordSys(sr.cval, &x)}.Err()
	defer C.free(unsafe.Pointer(x))
	return C.GoString(x), err
}
...
func (sr SpatialReference) MorphToESRI() error {
	return OGRErrContainer{C.OSRMorphToESRI(sr.cval)}.Err()
}

// Convert in place from ESRI WKT format
func (sr SpatialReference) MorphFromESRI() error {
	return OGRErrContainer{C.OSRMorphFromESRI(sr.cval)}.Err()
}
...
func (sr SpatialReference) SetAttrValue(path, value string) error {
	...
	return OGRErrContainer{C.OSRSetAttrValue(sr.cval, cPath, cValue)}.Err()
}
...
func (sr SpatialReference) SetAngularUnits(units string, radians float64) error {
	cUnits := C.CString(units)
	defer C.free(unsafe.Pointer(cUnits))
	return OGRErrContainer{C.OSRSetAngularUnits(sr.cval, cUnits, C.double(radians))}.Err()
}
...
func (sr SpatialReference) SetLinearUnits(name string, toMeters float64) error {
	...
	return OGRErrContainer{C.OSRSetLinearUnits(sr.cval, cName, C.double(toMeters))}.Err()
}
...
func (sr SpatialReference) SetTargetLinearUnits(target, units string, toMeters float64) error {
	...
	cUnits := C.CString(units)
	defer C.free(unsafe.Pointer(cUnits))
	return OGRErrContainer{C.OSRSetTargetLinearUnits(sr.cval, cTarget, cUnits, C.double(toMeters))}.Err()
}
...
func (sr SpatialReference) SetLinearUnitsAndUpdateParameters(name string, toMeters float64) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetLinearUnitsAndUpdateParameters(sr.cval, cName, C.double(toMeters))}.Err()
}
...
func (sr SpatialReference) SetLocalCS(name string) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetLocalCS(sr.cval, cName)}.Err()
}
...
func (sr SpatialReference) SetProjectedCS(name string) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetProjCS(sr.cval, cName)}.Err()
}
...
func (sr SpatialReference) SetGeocentricCS(name string) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetGeocCS(sr.cval, cName)}.Err()
}
...
func (sr SpatialReference) SetWellKnownGeographicCS(name string) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetWellKnownGeogCS(sr.cval, cName)}.Err()
}
...
func (sr SpatialReference) SetFromUserInput(name string) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetFromUserInput(sr.cval, cName)}.Err()
}
...
func (sr SpatialReference) CopyGeographicCSFrom(other SpatialReference) error {
	return OGRErrContainer{C.OSRCopyGeogCSFrom(sr.cval, other.cval)}.Err()
}

// Set the Bursa-Wolf conversion to WGS84
func (sr SpatialReference) SetTOWGS84(dx, dy, dz, ex, ey, ez, ppm float64) error {
	return OGRErrContainer{C.OSRSetTOWGS84(
		sr.cval,
		C.double(dx),
		C.double(dy),
		C.double(dz),
...
func (sr SpatialReference) TOWGS84() (coeff [7]float64, err error) {
	err = OGRErrContainer{C.OSRGetTOWGS84(sr.cval, (*C.double)(unsafe.Pointer(&coeff[0])), 7)}.Err()
	return
}
...
func (sr SpatialReference) SetCompoundCS(
	...
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetCompoundCS(sr.cval, cName, horizontal.cval, vertical.cval)}.Err()
}
...
func (sr SpatialReference) SetGeographicCS(
	...
	return OGRErrContainer{C.OSRSetGeogCS(
		sr.cval,
		cGeogName,
		cDatumName,
		cSpheroidName,
...
func (sr SpatialReference) SetVerticalCS(csName, datumName string, datumType int) error {
	...
	cDatumName := C.CString(datumName)
	defer C.free(unsafe.Pointer(cDatumName))
	return OGRErrContainer{C.OSRSetVertCS(sr.cval, cCSName, cDatumName, C.int(datumType))}.Err()
}
...
func (sr SpatialReference) SemiMajorAxis() (float64, error) {
	...
	return float64(axis), OGRErrContainer{cErr}.Err()
}
...
func (sr SpatialReference) InverseFlattening() (float64, error) {
	...
	return float64(flat), OGRErrContainer{cErr}.Err()
}
...
func (sr SpatialReference) SetAuthority(target, authority string, code int) error {
	...
	return OGRErrContainer{C.OSRSetAuthority(sr.cval, cTarget, cAuthority, C.int(code))}.Err()
}
...
func (sr SpatialReference) SetProjectionByName(name string) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetProjection(sr.cval, cName)}.Err()
}
...
func (sr SpatialReference) SetProjectionParameter(name string, value float64) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetProjParm(sr.cval, cName, C.double(value))}.Err()
}
...
func (sr SpatialReference) ProjectionParameter(name string, defaultValue float64) (float64, error) {
	...
	return float64(value), OGRErrContainer{cErr}.Err()
}
...
func (sr SpatialReference) SetNormalizedProjectionParameter(name string, value float64) error {
	cName := C.CString(name)
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetNormProjParm(sr.cval, cName, C.double(value))}.Err()
}
...
func (sr SpatialReference) SetUTM(zone int, north bool) error {
	return OGRErrContainer{C.OSRSetUTM(sr.cval, C.int(zone), BoolToCInt(north))}.Err()
}
...
func (sr SpatialReference) SetStatePlane(zone int, nad83 bool) error {
	return OGRErrContainer{C.OSRSetStatePlane(sr.cval, C.int(zone), BoolToCInt(nad83))}.Err()
}
...
func (sr SpatialReference) SetStatePlaneWithUnits(
	...
	return OGRErrContainer{C.OSRSetStatePlaneWithUnits(
		sr.cval,
		C.int(zone),
		BoolToCInt(nad83),
		cUnitName,
...
func (sr SpatialReference) AutoIdentifyEPSG() error {
	return OGRErrContainer{C.OSRAutoIdentifyEPSG(sr.cval)}.Err()
}
...
func (sr SpatialReference) SetACEA(
	...
	return OGRErrContainer{C.OSRSetACEA(
		sr.cval,
		C.double(stdp1),
		C.double(stdp2),
		C.double(centerLat),
...
func (sr SpatialReference) SetAE(centerLat, centerLong, falseEasting, falseNorthing float64) error {
	return OGRErrContainer{C.OSRSetAE(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetBonne(standardParallel, centralMeridian, falseEasting, falseNorthing float64) error {
	return OGRErrContainer{C.OSRSetBonne(
		sr.cval,
...
func (sr SpatialReference) SetCEA(stdp1, centralMeridian, falseEasting, falseNorthing float64) error {
	return OGRErrContainer{C.OSRSetCEA(
		sr.cval,
		C.double(stdp1),
		C.double(centralMeridian),
		C.double(falseEasting),
...
func (sr SpatialReference) SetCS(centerLat, centerLong, falseEasting, falseNorthing float64) error {
	return OGRErrContainer{C.OSRSetCS(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetEC(
	...
	return OGRErrContainer{C.OSRSetEC(
		sr.cval,
		C.double(stdp1),
		C.double(stdp2),
		C.double(centerLat),
...
func (sr SpatialReference) SetEckert(variation int, centralMeridian, falseEasting, falseNorthing float64) error {
	return OGRErrContainer{C.OSRSetEckert(
		sr.cval,
		C.int(variation),
		C.double(centralMeridian),
		C.double(falseEasting),
...
func (sr SpatialReference) SetEquirectangular(
	...
	return OGRErrContainer{C.OSRSetEquirectangular(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetEquirectangularGeneralized(
	...
	return OGRErrContainer{C.OSRSetEquirectangular2(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
...
func (sr SpatialReference) SetGS(centralMeridian, falseEasting, falseNorthing float64) error {
	return OGRErrContainer{C.OSRSetGS(
		sr.cval,
		C.double(centralMeridian),
		C.double(falseEasting),
		C.double(falseNorthing),
...
func (sr SpatialReference) SetGH(centralMeridian, falseEasting, falseNorthing float64) error {
	return OGRErrContainer{C.OSRSetGH(
		sr.cval,
		C.double(centralMeridian),
		C.double(falseEasting),
		C.double(falseNorthing),
...
func (sr SpatialReference) SetIGH() error {
	return OGRErrContainer{C.OSRSetIGH(sr.cval)}.Err()
}
...
func (sr SpatialReference) SetGEOS(
	...
	return OGRErrContainer{C.OSRSetGEOS(
		sr.cval,
		C.double(centralMeridian),
...
func (sr SpatialReference) SetGSTM(
	...
	return OGRErrContainer{C.OSRSetGaussSchreiberTMercator(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(scale),
...
func (sr SpatialReference) SetGnomonic(
	...
	return OGRErrContainer{C.OSRSetGnomonic(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetHOM(
	...
	return OGRErrContainer{C.OSRSetHOM(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(azimuth),
...
func (sr SpatialReference) SetHOM2PNO(
	...
	return OGRErrContainer{C.OSRSetHOM2PNO(
		sr.cval,
		C.double(centerLat),
		C.double(lat1),
		C.double(long1),
...
func (sr SpatialReference) SetIWMPolyconic(
	...
	return OGRErrContainer{C.OSRSetIWMPolyconic(
		sr.cval,
		C.double(lat1),
		C.double(lat2),
		C.double(centerLong),
...
func (sr SpatialReference) SetKrovak(
	...
	return OGRErrContainer{C.OSRSetKrovak(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(azimuth),
...
func (sr SpatialReference) SetLAEA(
	...
	return OGRErrContainer{C.OSRSetLAEA(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetLCC(
	...
	return OGRErrContainer{C.OSRSetLCC(
		sr.cval,
		C.double(stdp1),
		C.double(stdp2),
		C.double(centerLat),
...
func (sr SpatialReference) SetLCC1SP(
	...
	return OGRErrContainer{C.OSRSetLCC1SP(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(scale),
...
func (sr SpatialReference) SetLCCB(
	...
	return OGRErrContainer{C.OSRSetLCCB(
		sr.cval,
		C.double(stdp1),
		C.double(stdp2),
		C.double(centerLat),
...
func (sr SpatialReference) SetMC(
	...
	return OGRErrContainer{C.OSRSetMC(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetMercator(
	...
	return OGRErrContainer{C.OSRSetMercator(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(scale),
...
func (sr SpatialReference) SetMollweide(
	...
	return OGRErrContainer{C.OSRSetMollweide(
		sr.cval,
		C.double(centralMeridian),
		C.double(falseEasting),
		C.double(falseNorthing),
...
func (sr SpatialReference) SetNZMG(
	...
	return OGRErrContainer{C.OSRSetNZMG(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetOS(
	...
	return OGRErrContainer{C.OSRSetOS(
		sr.cval,
		C.double(originLat),
		C.double(meridian),
		C.double(scale),
...
func (sr SpatialReference) SetOrthographic(
	...
	return OGRErrContainer{C.OSRSetOrthographic(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetPolyconic(
	...
	return OGRErrContainer{C.OSRSetPolyconic(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetPS(
	...
	return OGRErrContainer{C.OSRSetPS(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(scale),
...
func (sr SpatialReference) SetRobinson(
	...
	return OGRErrContainer{C.OSRSetRobinson(
		sr.cval,
		C.double(centerLong),
		C.double(falseEasting),
		C.double(falseNorthing),
...
func (sr SpatialReference) SetSinusoidal(
	...
	return OGRErrContainer{C.OSRSetSinusoidal(
		sr.cval,
		C.double(centerLong),
		C.double(falseEasting),
		C.double(falseNorthing),
...
func (sr SpatialReference) SetStereographic(
	...
	return OGRErrContainer{C.OSRSetStereographic(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(scale),
...
func (sr SpatialReference) SetSOC(
	...
	return OGRErrContainer{C.OSRSetSOC(
		sr.cval,
...
func (sr SpatialReference) SetTM(
	...
	return OGRErrContainer{C.OSRSetTM(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(scale),
...
func (sr SpatialReference) SetTMVariant(
	...
	defer C.free(unsafe.Pointer(cName))
	return OGRErrContainer{C.OSRSetTMVariant(
		sr.cval,
		cName,
		C.double(centerLat),
		C.double(centerLong),
...
func (sr SpatialReference) SetTMG(
	...
	return OGRErrContainer{C.OSRSetTMG(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(falseEasting),
...
func (sr SpatialReference) SetTMSO(
	...
	return OGRErrContainer{C.OSRSetTMSO(
		sr.cval,
		C.double(centerLat),
		C.double(centerLong),
		C.double(scale),
...
func (sr SpatialReference) SetVDG(
	...
	return OGRErrContainer{C.OSRSetVDG(
		sr.cval,
		C.double(centerLong),
		C.double(falseEasting),
		C.double(falseNorthing),
